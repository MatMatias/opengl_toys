...
class GLAPP(ABC):
    def __init__(self):
        ...
        sdl2.SDL_SetWindowPosition(
            self.window, sdl2.SDL_WINDOWPOS_CENTERED, sdl2.SDL_WINDOWPOS_CENTERED
        )
        ...
        while running:
            ...
            self.mousePressed = (
                ...
                or self.mouseRightPressed
                or self.mouseMiddlePressed
            )
            # Show debug information in terminal
            print(
                f"\033[0G\033[0KMouse: \033[1;36m{self.mouseX}, {self.mouseY}\033[0m\tFrameCount: \033[1;31m{self.frameCount}\033[0m  ",
                end="",
                flush=True,
            )
            self.draw()
    ...
    def loadTexture(self, filename):
        ...
        GL.glTexImage2D(
            GL.GL_TEXTURE_2D, 0, modo, w, h, 0, modo, GL.GL_UNSIGNED_BYTE, data
        )
